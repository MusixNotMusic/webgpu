...
import vertexShadowWGSL from '../shaders/dragon/vertexShadow.wgsl';
import vertexWGSL from '../shaders/dragon/vertex.wgsl';
import fragmentWGSL from '../shaders/dragon/fragment.wgsl';
export default {
    name: 'triangle',
    setup() {
        ...
        const init = async ({ canvas }) => {
            ...
            function getCameraViewProjMatrix() {
                ...
                const rad = Math.PI * (Date.now() / 10000);
